...
// Translations
const translations = {
  en: { home: '𓋹 Home 𓋹', categories: '▼ Categories', lingerie: 'Lingerie', bath: 'Bath Stuff', towels: 'Towels', hero: 'Where Ancient Elegance
Meets Modern Desire', shop: 'Enter the Sanctuary', collection: '𓂀 Sacred Collection 𓂀', cart: 'Your Cart', empty: 'Cart is empty', checkout: 'Proceed to Checkout', about: 'about: "Our story begins in the most important place in the world: home. At Silk Island, we believe your quiet moments deserve the very best. That's why we created a sanctuary dedicated to fine textures and discreet elegance. From the sheets that turn your bedroom into a non-stop vacation, to the lingerie pieces that make you feel confident in your own skin, everything we choose has one goal: to bring you joy. We don't just sell products; we sell sensory experiences. We invite you to stop for a moment, choose quality, and... Discover the hidden beauty."', addVariant: '+ Add Another Color/Size', addToCart: 'Add to Cart', size: 'Size', color: 'Color', quantity: 'Quantity' },
  ro: { home: '𓋹 Acasă 𓋹', categories: '▼ Categorii', lingerie: 'Lingerie', bath: 'Produse Baie', towels: 'Prosoape', hero: 'Unde eleganța antică se întâlnește cu dorința modernă', shop: 'Intră în Sanctuar', collection: '𓂀 Colecția Sacră 𓂀', cart: 'Coșul Tău', empty: 'Coșul este gol', checkout: 'Finalizează Comanda', about: 'about: "Povestea noastră începe în cel mai important loc din lume: acasă. La Silk Island, credem că momentele tale de liniște merită ce e mai bun. De aceea am creat un sanctuar dedicat texturilor fine și eleganței discrete. De la cearșafurile care transformă dormitorul într-o vacanță non-stop, la piesele de lenjerie care te fac să te simți încrezătoare în propria piele, tot ce alegem are un singur scop: să-ți aducă bucurie. Nu vindem doar produse; vindem experiențe senzoriale. Te invităm să te oprești o clipă, să alegi calitatea și... Descoperă frumusețea ascunsă."', addVariant: '+ Adaugă Altă Culoare/Mărime', addToCart: 'Adaugă în Coș', size: 'Mărime', color: 'Culoare', quantity: 'Cantitate' },
  tr: { home: '𓋹 Ana Sayfa 𓋹', categories: '▼ Kategoriler', lingerie: 'İç Giyim', bath: 'Banyo Ürünleri', towels: 'Havlular', hero: 'Antik Mısır Roma Lüksüyle Buluşuyor • İç Giyim & Banyo Ritüelleri', shop: 'Tapınağa Gir', collection: '𓂀 Kutsal Koleksiyon 𓂀', cart: 'Sepetiniz', empty: 'Sepet boş', checkout: 'Ödemeye Geç', about: 'Hakkımızda: "Hikayemiz dünyanın en önemli yerinde başlıyor: evde. Silk Island'da, sakin anlarınızın en iyisini hak ettiğine inanıyoruz. Bu yüzden ince dokulara ve zarif şıklığa adanmış bir sığınak yarattık. Yatak odanızı kesintisiz bir tatile dönüştüren çarşaflardan, kendinizi teninizde özgüvenli hissetmenizi sağlayan iç çamaşırlarına kadar, seçtiğimiz her şeyin tek bir amacı var: size mutluluk getirmek. Biz sadece ürün satmıyoruz; duyusal deneyimler satıyoruz. Sizi bir an durmaya, kaliteyi seçmeye ve... Gizli güzelliği keşfetmeye davet ediyoruz."', addVariant: '+ Başka Renk/Beden Ekle', addToCart: 'Sepete Ekle', size: 'Beden', color: 'Renk', quantity: 'Adet' }
};
