...
const translations = {
  en: {
    ...
    shipping_details: 'Shipping Details', order_summary: 'Order Summary', subtotal: 'Subtotal',
    ...
    insurance_courier: 'Insurance & Courier', dispatch_note: . Expect a signature request upon arrival.',
